...
class Project_Merge(models.TransientModel):
    ...
    _description="Project Task Merge Wizard"

    user_ids = fields.Many2one('res.users',string='Assigned To',readonly=True, )
    ...
    def default_get(self, fields):
        ...
        if 'user_ids' in fields and not res.get('user_ids'):
            for user in current_task_id.user_ids:
