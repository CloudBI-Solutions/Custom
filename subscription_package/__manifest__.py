...
{
    'name': 'Subscription Management For CloudBI Fusion',
    'Version': '16.0.1.0.0',
    'summary': 'Subscription Package Management Module For CloudBI Fusion',
    'description': 'Subscription Package Management Module For CloudBI Fusion',
    'category': 'Sales',
