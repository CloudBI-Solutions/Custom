...
###################################################################################
{
    'name': 'Fusion HRMS Core',
    'version': '16.0.1.0.0',
    'summary': """Fusion HRMS Suit: Centralize all Fusion HRMS modules""",
    'description': """Main module of Fusion HRMS, It brings all others into a single module, Payroll, Payroll Accounting,Expense,
