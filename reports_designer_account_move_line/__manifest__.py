...
{
    'name': 'Account Move Line Report (XLSX)',
    'version': '1.0.0',
    'category': 'Extra Tools',
    'summary': 'Account Move Line Report (XLSX)',     
    'price': 0.00,
    'currency': 'EUR',
    "license": "OPL-1",     
    'description': """
Journal Items Report.
====================================
Journal Items Report in MS Excel format (XLSX)
...
Report for Report Designer (XLSX, XLSM). 
    ...
    'data': [
        'data/account_move_line_xlsx.xml',
    ],
    'qweb': [
    ],
    'demo': [],
