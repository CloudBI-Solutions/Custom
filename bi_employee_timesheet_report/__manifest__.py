...
# Part of BrowseInfo. See LICENSE file for full copyright and licensing details.
{
    ...
    'name': "HR Employee Timesheet Excel and PDF Report in CloudBI Fusion",
    'version': '16.0.0.1',
    'license':'OPL-1',
    ...
    'description': '''
      ...
      Human Resource Employee Timesheet PDF and Excel Report Fusion app helps you print PDF and Excel reports of employee timesheets for a specific time period. Users can choose to print timesheet reports for single or multiple employees within a particular date range as per their needs.
