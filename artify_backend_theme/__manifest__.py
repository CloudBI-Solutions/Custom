...
{
    "name": "Artify Backend Theme Fusion",
    "description": """Minimalist and elegant backend theme for CloudBI Fusion, Backend Theme""",
    "summary": "Artify Backend Theme Fusion is an attractive theme for backend",
