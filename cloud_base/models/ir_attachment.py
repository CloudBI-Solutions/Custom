...
class ir_attachment(models.Model):
    ...
    def copy(self, default=None):
        ...
        self.check("write")
        if self.for_delete:
            raise ValidationError(_("It is not possible to copy attachments marked for deletion"))
        if self.cloud_key:
            raise ValidationError(_("It is not possible to copy already synced attachments"))
