# -*- coding: utf-8 -*-
{
    ...
    "author": "faOtools",
    "website": "https://faotools.com/apps/16.0/cloud-storage-solutions-739",
    ...
    "assets": {
        "web.assets_backend": [
                ...
                "cloud_base/static/src/models/attachment/*.js",
                "cloud_base/static/src/models/attachment_list/*.js",
                "cloud_base/static/src/models/attachment_card/*.js",
                "cloud_base/static/src/models/thread/*.js",
                "cloud_base/static/src/models/file_uploader/*.js",
                ...
                "cloud_base/static/src/components/message_list/*.js",
                "cloud_base/static/src/components/attachment_box/*.xml",
                "cloud_base/static/src/components/attachment_box/*.js",
                "cloud_base/static/src/components/attachment_card/*.xml",
                "cloud_base/static/src/components/chatter_topbar/*.xml"
        ]
},
    "demo": [
    ...
    "summary": "The tool to flexibly structure Odoo attachments in folders and synchronize directories with cloud clients: Google Drive, OneDrive/SharePoint, Nextcloud/ownCloud, and Dropbox. DMS. File Manager. Document management system",
    "description": """For the full details look at static/description/index.html
* Features *
- CloudBI Fusion File Manager Interface
...
#odootools_proprietary""",
    ...
    "price": "245.0",
    "currency": "EUR",
    "live_test_url": "https://faotools.com/my/tickets/newticket?&url_app_id=11&ticket_version=16.0&url_type_id=3",
}
