...
{
    'name': 'CloudBI FUsion Full Accounting Kit',
    'version': '16.0.2.0.12',
    'category': 'Accounting',
    'live_test_url':
    ...
    'description': """
                    AccountingKit, Fullaccounting, all in one accounting,
                    ...
                    Lock Dates into CloudBI Fusion,
                    Odoo Accounting,CloudBI Fusion Accounting Reports,
                    Full Accounting, Complete Accounting,
                    Full Accounting Package,
                    Financial Reports, Financial Report for CloudBI Fusion,
                    Reconciliation Widget,
                    Reconciliation Widget For CloudBI Fusion,
                    Payments Matching
                    """,
